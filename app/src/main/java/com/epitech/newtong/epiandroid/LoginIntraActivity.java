 ...
 */
public class LoginIntraActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_login_intra);
...
/*    *//**
    ...
    private boolean isLoginValid(String Login) {
        if (Login.length() != 8 || Login.charAt(6) != '_')
            return (false);
        return (true);
    }
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        return new CursorLoader(null);
                ...
                ContactsContract.Contacts.Data.MIMETYPE +
                        " = ?", new String[]{ContactsContract.CommonDataKinds.Login
                                                                     .CONTENT_ITEM_TYPE},
...
/*    private interface ProfileQuery {
        String[] PROJECTION = {
                ContactsContract.CommonDataKinds.Login.ADDRESS,
                ContactsContract.CommonDataKinds.Login.IS_PRIMARY,
        };
    ...
    private void addLoginsToAutoComplete(List<String> LoginAddressCollection) {
        ...
        ArrayAdapter<String> adapter =
                new ArrayAdapter<>(LoginIntraActivity.this,
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                if (answer.getString("token") != null) {
                    return (true);
                }
